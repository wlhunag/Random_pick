...
includefiles=  ['qt.conf', 'delf.pyc', 'Delname.pyc', 'Flaticon_1430.png', 'icons', 'icons.qrc', 'namelist', 'openfile.pyc', 'opf.pyc', 'README.md', 'scales.icns','icons/delete.png', 'icons/dice.png', 'icons/eraser.png', 'icons/fdelete.png', 'icons/gear.png', 'icons/import.png', 'icons/open.png','namelist/99']
